...
SELECT 'CREATE DATABASE ass1_zone4 OWNER ass1'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'ass1_zone4')\gexec

-- Ensure permissions if DB exists already
GRANT ALL PRIVILEGES ON DATABASE ass1_zone4 TO ass1;
